...
{
    public class ProfileRepository : RepositoryBase<ProfileSetting, string>, IProfileRepository
    {
    ...
    public interface IProfileRepository : IRepository<ProfileSetting, string>
    {
